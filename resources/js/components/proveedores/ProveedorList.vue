        ...
        <div class="card-body">
          <div class="row align-items-center">
            <div class="col-md-4">
              ...
              <small class="text-muted">Administra tus proveedores y suministros</small>
            </div>
            <div class="col-md-8">
          ...
          <form @submit.prevent="guardarProveedor">
            ...
            <div class="card mb-4">
              <div class="card-header bg-light">
                <h6 class="mb-0">
                  <i class="fas fa-building me-2" />Datos de
                  Empresa/Persona
                </h6>
              </div>
              <div class="card-body">
            ...
            <div class="card mb-4">
              <div class="card-header bg-light">
                <h6 class="mb-0">
                  <i class="fas fa-clipboard-list me-2" />Datos de Proveedor
                </h6>
              </div>
              <div class="card-body">
                <div class="row">
                  ...
                  <!-- Límite de Crédito -->
                  <div class="col-md-3 mb-3">
                    <label class="form-label">Límite de Crédito (nos
                      otorgan)</label>
            ...
            <div class="card mb-4">
              <div class="card-header bg-light">
                <h6 class="mb-0">
                  <i class="fas fa-user-tie me-2" />Persona
                  de Contacto
                </h6>
              </div>
              <div class="card-body">
