    ...
    <div class="row">
      ...
      <div class="col-lg-3 mb-4">
        <div class="card shadow-sm h-100">
          <div class="card-header bg-gradient-primary text-white">
            <h5 class="mb-0">
              <i class="fas fa-file-pdf me-2" />Tipos de Reportes
            </h5>
          </div>
      ...
      <div class="col-lg-9">
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            ...
            <div class="row mb-4">
              ...
              <template v-if="tipoSeleccionado === 'ventas'">
                <div class="col-md-3 mb-3">
                  ...
                  >
                    ...
                    <option
                      v-for="cliente in datosF.clientes"
                      :key="cliente.id"
                      :value="cliente.id"
                    >
                      {{ cliente.nombre }}
              ...
              <template v-if="tipoSeleccionado === 'compras'">
                <div class="col-md-3 mb-3">
                  ...
                  >
                    ...
                    <option
                      v-for="prov in datosF.proveedores"
                      :key="prov.id"
                      :value="prov.id"
                    >
                      {{ prov.nombre }}
              ...
              <template v-if="tipoSeleccionado === 'inventario'">
                <div class="col-md-4 mb-3">
                  ...
                  >
                    ...
                    <option
                      v-for="cat in datosF.categorias"
                      :key="cat.id"
                      :value="cat.id"
                    >
                      {{ cat.nombre }}
              ...
              <template v-if="['clientes', 'proveedores'].includes(tipoSeleccionado)">
                <div class="col-md-4 mb-3">
                  <label class="form-label">Estado</label>
                  <select
                    v-model="filtros.estado_entidad"
                    class="form-select"
                  >
                    <option value="">
                      Todos
            ...
            <div class="d-flex gap-3">
              ...
              >
                <i class="fas fa-eraser me-2" />Limpiar Filtros
              </button>
            </div>
          </div>
        </div>
        ...
        <div class="card shadow-sm mt-4">
          <div class="card-header bg-light">
            <h6 class="mb-0">
              <i class="fas fa-info-circle me-2" />Información del Reporte
            </h6>
          </div>
          <div class="card-body">
            <div class="row">
